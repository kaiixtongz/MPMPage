	...
	<div id="main">
		...
		<div class="headerbar">
			...
			<div class="headerbar-left">
				<a href="<?php echo SITE_URL('Dashboard'); ?>" class="logo"><img src="<?php echo BASE_URL('assets/Admin/'); ?>assets/images/logo.png"> <span>MPM Manager</span></a>
			</div>
				...
				<ul class="list-inline float-right mb-0">
						...
						<div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg">
							...
							<a href="#" class="dropdown-item notify-item">
								<div class="notify-icon bg-faded">
									<img src="<?php echo BASE_URL('assets/Admin/'); ?>assets/images/avatars/avatar2.png" alt="img" class="rounded-circle img-fluid">
								</div>
							...
							<a href="#" class="dropdown-item notify-item">
								<div class="notify-icon bg-faded">
									<img src="<?php echo BASE_URL('assets/Admin/'); ?>assets/images/avatars/avatar3.png" alt="img" class="rounded-circle img-fluid">
								</div>
								<p class="notify-details">
									<b>Michael Cox</b>
							...
							<a href="#" class="dropdown-item notify-item">
								<div class="notify-icon bg-faded">
									<img src="<?php echo BASE_URL('assets/Admin/'); ?>assets/images/avatars/avatar4.png" alt="img" class="rounded-circle img-fluid">
								</div>
								<p class="notify-details">
					...
					<li class="list-inline-item dropdown notif">
						<a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
							<!-- <img src="<?php echo BASE_URL('assets/Admin/'); ?>assets/images/avatars/admin.png" alt="Profile image" class="avatar-rounded"> -->
							<img src="https://graph.facebook.com/<?php echo $_SESSION['facebookId'] ?>/picture" alt="Profile image" class="avatar-rounded">
						</a>
						<div class="dropdown-menu dropdown-menu-right profile-dropdown ">
							<!-- item-->
							<div class="dropdown-item noti-title">
								<h5 class="text-overflow"><small><?php echo $_SESSION['profileFname'] . " " . $_SESSION['profileLname']; ?></small> </h5>
							</div>
