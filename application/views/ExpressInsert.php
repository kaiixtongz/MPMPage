<?php echo form_open_multipart('Express/ExpressInsert')?>

<div class="modal fade bd-example-modal-l" id="ExpressInsert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">

      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">เพิ่มการจัดส่ง</h5>
          ...
          <table style="width:70%">
            <tr>
              ...
              <tr>
                ...
                <td class="text-center"><input autocomplete="off" name="expressPrice" type="text" class="form-control" required></td>
              </tr>
